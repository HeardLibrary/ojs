		...
		<header class="navbar navbar-default" id="headerNavigationContainer" role="banner">
			...
			<div class="container-fluid">
				<div class="row"> 
					...
					<img class="img-responsive" src="/public/journals/17/pageHeaderLogoImage_en_US.png" alt="AADSJUR Logo"></div>  -->
					<img class="img-responsive" src="/public/journals/17/vu_logo_header.png" alt="VU Logo">
				</div>
				<div class="row">
