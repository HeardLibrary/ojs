...
class homileticThemePlugin extends ThemePlugin {
	...
	public function init() {
		...
		// modify not working, need to figure out later
		//$this->modifyStyle('stylesheet', array('addLess' => array('styles/homiletic.less')));
		$this->addStyle('homiletic', 'styles/homiletic.less'); 
	}
