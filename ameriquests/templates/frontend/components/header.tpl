 ...
 * Customize header.tpl for AmeriQuests based on bootstrap3 basic theme 
...
<body class="pkp_page_{$requestedPage|escape|default:"index"} pkp_op_{$requestedOp|escape|default:"index"}{if $showingLogo} has_site_logo{/if}">
	<div class="pkp_structure_page">
		...
		<header class="navbar navbar-default" id="headerNavigationContainer" role="banner">
			<!-- customized site-name div for AmeriQuests -->
			...
			{* Logo or site title. Only use <h1> heading on the homepage.
				...
				{/if}
					...
					{if $displayPageHeaderLogo && is_array($displayPageHeaderLogo)}
						<a href="{$homeUrl}">
							<img class="img-responsive img-logo" src="{$publicFilesDir}/{$displayPageHeaderLogo.uploadName|escape:"url"}" {if $displayPageHeaderLogo.altText != ''}alt="{$displayPageHeaderLogo.altText|escape}"{else}alt="{translate key="common.pageHeaderLogo.altText"}"{/if}>
						</a>
...
<!-- 			
			...
			<!-- end of customized AmeriQuests logo div --> 
